...
export default function ProjetoCard({
  ...
  return (
    ...
    >
      ...
      {/* Nome do projeto */}
      <p className="mt-2 text-base font-semibold text-white">{projeto}</p>
      ...
      {/* Informações */}
      <div className="flex items-start justify-between">
        <p className="text-xs text-[#EF7541]">PO: {po}</p>

        <p className="text-xs text-slate-400">Criado em: {dataFormatada}</p>
      </div>
    </Link>
  )
}
